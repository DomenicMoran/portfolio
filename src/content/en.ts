...
export const en: Content = {
  ...
  hero: {
    ...
    proof: [
      ...
      { value: "4,065", label: "commits since March 2026" },
  ...
  about: {
    ...
    stats: [
      { value: "4,065", label: "commits since March 2026", note: "alongside a full-time job" },
    ...
    statsHinweis:
      "Measured on August 1, 2026 with git rev-list --count across all 9 repositories: the three monorepos behind MenuCloud, Salati and NOURI, this site, the Prüfstand and the four published packages. Counted on the main branch; across all refs it would be 4,256. The count keeps growing, so any deviation is higher, not lower.",
    timelineLabel: "Path",
    timeline: [
      {
